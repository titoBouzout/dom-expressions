...
var _tmpl$ = /*#__PURE__*/ _$template(`<div><h1><a href=/>Welcome`),
  ...
  _tmpl$49 = /*#__PURE__*/ _$template(`<div class=todo>`),
  _tmpl$50 = /*#__PURE__*/ _$template(`<div class="todo item">`);
...
_$setProperty(_el$9, "textContent", /*@once*/ state.content);
_$effect(
  () => state.name,
  _v$ => {
...
const template78 = _el$99;
var _el$100 = _$getNextElement(_tmpl$4);
_$setStyleProperty(_el$100, "height", /* @once */ props.height);
_$setAttribute(_el$100, "something", /*@once*/ color());
_$effect(
  () => props.width,
  _v$ => {
...
_$style(_el$106, /* @once */ styleProp.style);
const template85 = _el$106;
...
const template87 = _el$108;
var _el$109 = _$getNextElement(_tmpl$47);
_$style(_el$109, /* @once*/ style);
_$className(_el$109, /* @once*/ style);
